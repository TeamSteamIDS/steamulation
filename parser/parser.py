...
driver2.get("http://store.steampowered.com/agecheck/app/608800/")
time.sleep(1)
...
#scrolling
driver.get("http://steamcommunity.com/app/608800/reviews/?browsefilter=toprated&snr=1_5_reviews_")
time.sleep(1)
curParse = 0
count = 0
